...
Produces: docutag-v1-2-0-controller (dots replaced with dashes for DNS compatibility)
*/}}
...
{{- if .context.Values.global }}
  {{- if .context.Values.global.imageVersion }}
    {{- $versionWithDashes := .context.Values.global.imageVersion | replace "." "-" -}}
    {{- $version = printf "-v%s" $versionWithDashes -}}
  {{- end -}}
{{- end -}}
