...
The application is hosted at: **https://docutag.honker**

Your external reverse proxy (Caddy, Nginx, Traefik, etc.) should route:
- `docutag.honker` → `localhost:3001` (web container)
...
- `ghcr.io/docutag/platform-textanalyzer:staging`
- `ghcr.io/docutag/platform-scraper:staging`
- `ghcr.io/docutag/platform-controller:staging`
- `ghcr.io/docutag/platform-scheduler:staging`
- `ghcr.io/docutag/platform-web:staging`
...
The application is configured for subdomain hosting at `docutag.honker`:
...
docker pull ghcr.io/docutag/platform-web:staging
```
...
3. Pushes images to `ghcr.io/docutag/platform-*:staging`
...
- Go to: https://github.com/docutag/platform/actions
...
- **Images**: `ghcr.io/docutag/platform-{textanalyzer,scraper,controller,scheduler,web}:staging`
